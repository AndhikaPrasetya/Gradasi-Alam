...
export default async function Hero({hero}: {hero: SiteContent['hero']}) {
  ...
  return (
    <section className="relative overflow-hidden bg-forest-depths px-24 pt-128 pb-[200px] text-center">
      <div
        aria-hidden
      ...
      <div className="relative mx-auto flex max-w-[800px] flex-col items-center gap-24">
        ...
        <p className="max-w-[640px] text-subheading text-pale-fern">
      ...
      <div
        aria-hidden
        className="pointer-events-none relative mx-auto mt-64 hidden h-[160px] w-[560px] max-w-full md:block"
      >
        ...
        <img
          ...
          alt=""
          className="absolute left-0 top-0 h-[140px] w-[260px] -rotate-6 rounded-cards object-cover opacity-90 shadow-[0_24px_60px_rgba(0,0,0,0.35),0_4px_12px_rgba(0,0,0,0.2)]"
        />
        {/* eslint-disable-next-line @next/next/no-img-element -- decorative SVG placeholder, swapped once real project photos exist */}
        <img
          src="/images/projects/residential-1.svg"
          alt=""
          className="absolute right-0 top-8 h-[150px] w-[280px] rotate-6 rounded-cards object-cover shadow-[0_24px_60px_rgba(0,0,0,0.35),0_4px_12px_rgba(0,0,0,0.2)]"
        />
      </div>
    </section>
  );
